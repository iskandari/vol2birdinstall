...
sudo apt-get install --no-install-recommends -y libcsv-dev libconfuse-dev libhdf5-dev gcc g++ wget unzip make cmake zlib1g-dev flex-old file automake libtool || exit_with_error 127 "Could not install dependencies"
